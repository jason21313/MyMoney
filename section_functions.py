...
def account(top_text,inner_frame,root):
    delete_contents(inner_frame)
    top_text.configure(text="MyAccount")
    first_name=ctk.CTkLabel(inner_frame,text=f"First Name: {first[0].upper()}{first[1:]} ",font=("Trebuchet MS",30),text_color="black")
    first_name.grid(row=0,column=0,pady=100,padx=50)
    last_name=ctk.CTkLabel(inner_frame,text=f"Last Name: {last[0].upper()}{last[1:]} ",font=("Trebuchet MS",30),text_color="black")
    last_name.grid(row=0,column=2,pady=100,padx=50)
    email_text=ctk.CTkLabel(inner_frame,text=f"Email: {email} ",font=("Trebuchet MS",30),text_color="black")
    email_text.grid(row=1,column=0,pady=50,padx=50)
    dob_text=ctk.CTkLabel(inner_frame,text=f"Date of Birth: {dob} ",font=("Trebuchet MS",30),text_color="black")
    dob_text.grid(row=1,column=2,pady=50,padx=50)
    edit_profile_button=ctk.CTkButton(inner_frame,text="Click to Edit Profile",font=("Trebuchet MS",30),
    ...
    logout_button=ctk.CTkButton(inner_frame,text="Press to Logout", width=125,height=40,
                                font=("Trebuchet MS",30),command=lambda: logout(root))
    logout_button.grid(row=2,column=2,pady=(50,0),padx=50)
    delete_account_button = ctk.CTkButton(inner_frame, text="Delete Account", font=("Trebuchet MS", 25),width=123,height=40,hover_color="#420D09",
...
def edit_profile(top_text,inner_frame,root):
    ...
    first_text=ctk.CTkLabel(inner_frame,text="Please enter your First Name Below",font=("Trebuchet MS",30),text_color="black")
    first_text.grid(row=0,column=0,pady=(150,0),padx=(100,0))
    first_name_input=ctk.CTkEntry(inner_frame,placeholder_text="Enter Here: ",font=("Trebuchet MS",15),
                                  width=300,height=40,fg_color="lightgray",text_color="#4A4A4A")
    first_name_input.grid(row=1,column=0,pady=(0,100),padx=(100,0))
    last_text = ctk.CTkLabel(inner_frame, text="Please enter your Last Name Below", font=("Trebuchet MS", 30),text_color="black")
    last_text.grid(row=0,column=2,pady=(150,0),padx=(0,225))
    last_name_input=ctk.CTkEntry(inner_frame,placeholder_text="Enter Here: ",font=("Trebuchet MS",15),
                                 width=300,height=40,fg_color="lightgray",text_color="#4A4A4A")
    last_name_input.grid(row=1,column=2,pady=(0,100),padx=(0,225))
    email_text = ctk.CTkLabel(inner_frame, text="Please enter your Email Below", font=("Trebuchet MS", 30),text_color="black")
    email_text.grid(row=2,column=0,pady=0,padx=(100,0))
    email_input=ctk.CTkEntry(inner_frame,placeholder_text="Enter Here: ",font=("Trebuchet MS",15),
                             width=300,height=40,fg_color="lightgray",text_color="#4A4A4A")
    email_input.grid(row=3,column=0,pady=(0,100),padx=(100,0))
    dob_text = ctk.CTkLabel(inner_frame, text="Please enter your Date of Birth Below", font=("Trebuchet MS", 30),text_color="black")
    dob_text.grid(row=2,column=2,pady=0,padx=(0,225))
    dob_input=ctk.CTkEntry(inner_frame,placeholder_text="Enter Here(dd/mm/yyyy): ",font=("Trebuchet MS",15),
                           width=300,height=40,fg_color="lightgray",text_color="#4A4A4A")
    dob_input.grid(row=3,column=2,pady=(0,100),padx=(0,225))
    save_changes_button=ctk.CTkButton(inner_frame,text="Save Changes",font=("Trebuchet MS",25),height=70,width=175,
...
def save_changes(new_first_name,new_last_name,new_email,new_dob,top_text,inner_frame,root,save_changes_button):
    ...
    account(top_text,inner_frame,root)
...
def delete_safeguard(delete_account_button,inner_frame,root):
    ...
    password_entry=ctk.CTkEntry(inner_frame,placeholder_text="Enter Password:",
                                font=("Trebuchet MS",15),width=175,height=40)
    password_entry.grid(row=4,column=1,pady=5,padx=0)
    actually_delete_button=ctk.CTkButton(inner_frame,text="Actually Delete Account",font=("Trebuchet MS",18),fg_color="#960019",
...
def delete_account(password,inner_frame,root):
    if password=="temp":
        ...
        error=ctk.CTkLabel(inner_frame,text="Incorrect Password",font=("Trebuchet MS",25),text_color="red")
...
def logout(root):
    ...
    frame = ctk.CTkFrame(root, width=w // 4, height=h // 3 -100, fg_color='white', corner_radius=0)
    frame.pack_propagate(False)
    frame.pack()
    text=ctk.CTkLabel(frame,text="Thank you for using MyMoney\n\nClose the Application\nto Finish!",text_color="black",
