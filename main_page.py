...
def create_main(root):
    ...
    top=ctk.CTkLabel(top_frame,text=f"Welcome Back {temp[0].upper()}{temp[1:]}",text_color='black',font=("Trebuchet MS",25,"bold"))
    top.pack(pady=10,anchor='n')
    top_frame.pack_propagate(False)
    ...
    home_b=ctk.CTkButton(outer_frame,text='Home',height=75,fg_color="#7851A9",font=("Trebuchet MS",25,"bold"),text_color='#d7d7d7')
    budget_b = ctk.CTkButton(outer_frame, text='Budget',height=75,fg_color="#9867C5",font=("Trebuchet MS",25,"bold"),text_color='#d7d7d7')
    savings_b = ctk.CTkButton(outer_frame, text='Savings',height=75,fg_color="#9479D5",font=("Trebuchet MS",25,"bold"),text_color='#d7d7d7')
    tracking_b = ctk.CTkButton(outer_frame, text='Tracking',height=75,fg_color="#9975B9",font=("Trebuchet MS",25,"bold"),text_color='#d7d7d7')
    payments_b = ctk.CTkButton(outer_frame, text='Payments',height=75,fg_color="#6C3BAA",font=("Trebuchet MS",25,"bold"),text_color='#d7d7d7')
    account_b = ctk.CTkButton(outer_frame, text='Account',height=75,fg_color="#b081ff",font=("Trebuchet MS",25,"bold"),text_color='#d7d7d7')
